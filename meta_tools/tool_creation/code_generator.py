...
from data_models.shared_models import ToolRequirement, RetrievedDocument
from utils.rag_doc import DocumentRetriever


class CodeGenerator:
    
    def __init__(self, vectordb_path: str = "vectordb/docs"):
        self.llm_client = LLMClient()
        self.document_retriever = DocumentRetriever(vectordb_path)
